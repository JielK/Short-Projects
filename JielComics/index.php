    ...
    <img class="logo" src="assets/img/logo.png" width="45px">
     ...
     <div class="collapse navbar-collapse mx-4" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="allcomics.php">Comics</a>
          </li>
...
<div class="owl-carousel owl-theme"  style="width: 700px; height: 300px;">
  ...
  <div class="item">
    <div style="
    background: rgba(0, 0, 0, 0.6) url(comics/<?php echo $row['folder']; ?>/cover.png);
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
<div class="latest">
  <span class="latest-text mx-4">Latest Uploads</span>
  <hr class="chunkyhr">
